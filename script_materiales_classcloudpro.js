...
{ name: 'Introducción al Curso: Arduino vs Microcontrolador PIC', icon: 'fas fa-play-circle', url: 'https://drive.google.com/drive/folders/1WZYa2_hLEw_puri8uNFBlAegHqUsRB9l?usp=sharing', category: 'robotica', description: 'Panorama general del curso, sus objetivos y qué aprenderás sobre Arduino y PIC.' },
{ name: 'Comparativa Inicial: Arduino vs PIC', icon: 'fas fa-exchange-alt', url: 'https://drive.google.com/drive/folders/1VXXfNAjUvOD4oqZAwEQqVbPVDKncy-Mt?usp=sharing', category: 'robotica', description: 'Diferencias clave entre ambas plataformas en cuanto a facilidad, potencia y aplicaciones.' },
{ name: 'Primeros Pasos con Arduino', icon: 'fas fa-microchip', url: 'https://drive.google.com/drive/folders/1koUHW03UzyMZKEt-HOUDlTJje7gFA9WS?usp=sharing', category: 'robotica', description: 'Configuración inicial y fundamentos básicos para trabajar con Arduino.' },
{ name: 'Estructura de un Programa en Arduino', icon: 'fas fa-code', url: 'https://drive.google.com/drive/folders/1yJpl0y5LczMttK1fUFF491gQqD1D8Qt8?usp=sharing', category: 'robotica', description: 'Cómo se organiza el código en Arduino: setup(), loop() y convenciones.' },
{ name: 'Uso de Operadores en Arduino', icon: 'fas fa-equals', url: 'https://drive.google.com/drive/folders/1tgC8Oj41My0CYlhiPLb2kmVnY2doaAqN?usp=sharing', category: 'robotica', description: 'Explicación de operadores aritméticos, lógicos y relacionales en programación Arduino.' },
{ name: 'Sentencias de Control en Arduino', icon: 'fas fa-random', url: 'https://drive.google.com/drive/folders/1AVz-QH5BYUf9oYgDL4OhBIf9XLb1Siqc?usp=sharing', category: 'robotica', description: 'Uso de estructuras condicionales y de repetición para controlar el flujo del programa.' },
{ name: 'Comunicación Serial: Recibir Parámetros', icon: 'fas fa-usb', url: 'https://drive.google.com/drive/folders/1n4hSVRSLMNbg9B1GuNs6GHbi_fvaRdYd?usp=sharing', category: 'robotica', description: 'Cómo recibir datos desde el puerto serial para controlar el comportamiento del código.' },
{ name: 'Botón con LED: Entrada y Salida Digital', icon: 'fas fa-toggle-on', url: 'https://drive.google.com/drive/folders/1o8_qWo1KM24DiwAl5cnkDqeZY1BoXKUj?usp=sharing', category: 'robotica', description: 'Proyecto básico de interacción usando un botón para activar un LED.' },
{ name: 'Temporización con millis() en Arduino', icon: 'fas fa-stopwatch', url: 'https://drive.google.com/drive/folders/1VBFcz-nevaUAKr6J_k57JzKnUYYp_j9Z?usp=sharing', category: 'robotica', description: 'Técnica para medir tiempo sin bloquear el programa con delay().' },
{ name: 'Control de PWM en Arduino', icon: 'fas fa-wave-square', url: 'https://drive.google.com/drive/folders/1rU67kSe3l9cB3SepU9BZm4Zy-af_PLtN?usp=sharing', category: 'robotica', description: 'Uso de modulación por ancho de pulso para controlar intensidad o velocidad.' },
{ name: 'Aplicaciones con Sensores y Módulos en Arduino', icon: 'fas fa-satellite-dish', url: 'https://drive.google.com/drive/folders/1j0fr_IyUeW7OlPS2hsJj2k1lERJXCFAK?usp=sharing', category: 'robotica', description: 'Ejemplos prácticos utilizando sensores comunes con Arduino.' },
{ name: 'Proyectos con Arduino', icon: 'fas fa-project-diagram', url: 'https://drive.google.com/drive/folders/1AP5bmMucGs_0q0I1BBAE4bb8I4SxIVpT?usp=sharing', category: 'robotica', description: 'Aplicaciones completas que integran sensores, lógica y salidas.' },
{ name: 'Introducción a Microcontroladores PIC', icon: 'fas fa-microchip', url: 'https://drive.google.com/drive/folders/1pf1lrAvbkPYfkkUo05bB2O8JLelhhtUP?usp=sharing', category: 'robotica', description: 'Primeros pasos en la programación y uso de microcontroladores PIC.' },
{ name: 'Programación en Lenguaje PBP (PIC Basic Pro)', icon: 'fas fa-terminal', url: 'https://drive.google.com/drive/folders/1BBFrr57sbqkzsSwyLUtdTKpVk6Nrm5Nw?usp=sharing', category: 'robotica', description: 'Uso del lenguaje PBP para programar microcontroladores PIC de forma estructurada.' },
{ name: 'Aplicaciones con Sensores y Módulos en PIC', icon: 'fas fa-plug', url: 'https://drive.google.com/drive/folders/1amMEusJmXji2jpdDxullihwkOcEMCM_g?usp=sharing', category: 'robotica', description: 'Implementación de sensores y periféricos en proyectos con PIC.' },
{ name: 'Proyectos con Microcontroladores PIC', icon: 'fas fa-cogs', url: 'https://drive.google.com/drive/folders/12g-Y4tEUwkyfAX2nX2MXrk6MgLYBay1p?usp=sharing', category: 'robotica', description: 'Desarrollo de proyectos reales usando PIC y sus capacidades de control.' }
